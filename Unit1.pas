...
var
  ...
  result_text:string;
  //39
  goroda:array[1..40] of string=('Москва','Санкт-Петербург','Барнаул','Биробиджан','Благовещенск','Владивосток','Волгоград',
  ...
  'Омск','Орел','Пермь','Ростов-на-Дону','Сургут','Томск','Тюмень','Улан-Удэ','Уссурийск','Уфа','Хабаровск','Челябинск','Чита','Ярославль');
  ...
  'http://tesgroup.ru/filials/Chita/',              //Чита
